...
<body class="bg-slate-50 text-slate-900 flex min-h-screen">
    ...
    <a href="{{ route('admin.jabatans.index') }}"
        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.jabatans.*') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800' }} rounded-xl font-bold transition">

        <svg class="w-5 h-5 {{ request()->routeIs('admin.jabatans.*') ? 'text-indigo-300' : 'text-indigo-400' }}"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24">
            ...
            <path stroke-linecap="round"
                ...
                stroke-width="2"
                d="M8 7h8M8 12h8M8 17h8M5 7h.01M5 12h.01M5 17h.01"/>
    ...
    <a href="{{ route('admin.penguruses.index') }}"
        class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.penguruses.*') ? 'bg-indigo-800 text-white' : 'hover:bg-indigo-800' }} rounded-xl font-bold transition">

        <svg class="w-5 h-5 {{ request()->routeIs('admin.penguruses.*') ? 'text-indigo-300' : 'text-indigo-400' }}"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24">
